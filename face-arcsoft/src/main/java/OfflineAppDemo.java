...
//        engineConfiguration.setDetectFaceOrientPriority(DetectOrient.ASF_OP_ALL_OUT);
        ...
        String file="C:\\Users\\Administrator\\Desktop\\v2.mp4";
        //本地摄像头视频进行人脸识别
        OpenCVFrameGrabber grabber = null; //帧抓取器
        try{
            //抓取摄像头
            grabber = new OpenCVFrameGrabber(new File(file));
            ...
            File outDir=new File("C:\\Users\\Administrator\\Desktop\\OUT");
...
//                 frame = grabber.grabImage();
                ...
                if(faceNum > 0){
                    ...
                    faceEngine.extractFaceFeature(imageData,iplImage.width(), iplImage.height(),ImageFormat.CP_PAF_BGR24,imageInfoList.get(0),faceFeature);
                    System.out.println("提取到的人脸特征数据:"+faceFeature);
